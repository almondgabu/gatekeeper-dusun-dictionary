...
const MENU_ITEMS = [
  ...
  { label: 'Learn Dusun', href: '/product-roadmap#learning', icon: MessagesSquare },
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <div
        ...
        role="menu"
        className={[
          'absolute right-0 top-12 z-30 w-64 origin-top-right rounded-xl border border-[#D4AF37]/45 bg-[#2C1B12] p-2 shadow-2xl transition-all duration-200',
